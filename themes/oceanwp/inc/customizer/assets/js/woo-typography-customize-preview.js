...
(function ($) {
    ...
    api("woo_store_notice_typography[font-family]", function ($swipe) {
        $swipe.bind(function (pair) {
            if (pair) {
                /** @type {string} */
                var idfirst =
                    (pair.trim().toLowerCase().replace(" ", "-"), "customizer-typography-store-notice-font-family");
                var fontSize = pair.replace(" ", "%20");
                fontSize = fontSize.replace(",", "%2C");
                /** @type {string} */
                fontSize = oceanwpTG.googleFontsUrl + "/css?family=" + pair + ":" + oceanwpTG.googleFontsWeight;
            ...
            var $child = $(".customizer-typography-store-notice-font-family");
            if (pair) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-font-family">.woocommerce-store-notice.demo_store{font-family: ' +
                    pair +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[font-weight]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-font-weight");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-font-weight">.woocommerce-store-notice.demo_store{font-weight: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[font-style]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-font-style");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-font-style">.woocommerce-store-notice.demo_store{font-style: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[color]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-color");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-color">.woocommerce-store-notice.demo_store{color: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-font-size");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-font-size">.woocommerce-store-notice.demo_store{font-size: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_tablet_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice-tablet-font-size");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice-tablet-font-size">@media (max-width: 768px){.woocommerce-store-notice.demo_store{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_mobile_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice-mobile-font-size");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice-mobile-font-size">@media (max-width: 480px){.woocommerce-store-notice.demo_store{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-line-height");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-line-height">.woocommerce-store-notice.demo_store{line-height: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_tablet_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice-tablet-line-height");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice-tablet-line-height">@media (max-width: 768px){.woocommerce-store-notice.demo_store{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_mobile_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice-mobile-line-height");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice-mobile-line-height">@media (max-width: 480px){.woocommerce-store-notice.demo_store{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-letter-spacing");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-letter-spacing">.woocommerce-store-notice.demo_store{letter-spacing: ' +
                    dataAndEvents +
                    "px;}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_tablet_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice-tablet-letter-spacing");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice-tablet-letter-spacing">@media (max-width: 768px){.woocommerce-store-notice.demo_store{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_mobile_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice-mobile-letter-spacing");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice-mobile-letter-spacing">@media (max-width: 480px){.woocommerce-store-notice.demo_store{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_typography[text-transform]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-notice-text-transform");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-notice-text-transform">.woocommerce-store-notice.demo_store{text-transform: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[font-family]", function ($swipe) {
        $swipe.bind(function (pair) {
            if (pair) {
                /** @type {string} */
                var idfirst =
                    (pair.trim().toLowerCase().replace(" ", "-"), "customizer-typography-store-dismiss-notice-font-family");
                var fontSize = pair.replace(" ", "%20");
                fontSize = fontSize.replace(",", "%2C");
                /** @type {string} */
                fontSize = oceanwpTG.googleFontsUrl + "/css?family=" + pair + ":" + oceanwpTG.googleFontsWeight;
            ...
            var $child = $(".customizer-typography-store-dismiss-notice-font-family");
            if (pair) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-font-family">.demo_store .woocommerce-store-notice__dismiss-link{font-family: ' +
                    pair +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[font-weight]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-font-weight");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-font-weight">.demo_store .woocommerce-store-notice__dismiss-link{font-weight: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[font-style]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-font-style");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-font-style">.demo_store .woocommerce-store-notice__dismiss-link{font-style: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[color]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-color");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-color">.demo_store .woocommerce-store-notice__dismiss-link{color: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-font-size");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-font-size">.demo_store .woocommerce-store-notice__dismiss-link{font-size: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_tablet_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice_dismiss_link-tablet-font-size");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice_dismiss_link-tablet-font-size">@media (max-width: 768px){.demo_store .woocommerce-store-notice__dismiss-link{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_mobile_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice_dismiss_link-mobile-font-size");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice_dismiss_link-mobile-font-size">@media (max-width: 480px){.demo_store .woocommerce-store-notice__dismiss-link{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-line-height");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-line-height">.demo_store .woocommerce-store-notice__dismiss-link{line-height: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_tablet_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice_dismiss_link-tablet-line-height");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice_dismiss_link-tablet-line-height">@media (max-width: 768px){.demo_store .woocommerce-store-notice__dismiss-link{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_mobile_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice_dismiss_link-mobile-line-height");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice_dismiss_link-mobile-line-height">@media (max-width: 480px){.demo_store .woocommerce-store-notice__dismiss-link{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-letter-spacing");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-letter-spacing">.demo_store .woocommerce-store-notice__dismiss-link{letter-spacing: ' +
                    dataAndEvents +
                    "px;}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_tablet_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice_dismiss_link-tablet-letter-spacing");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice_dismiss_link-tablet-letter-spacing">@media (max-width: 768px){.demo_store .woocommerce-store-notice__dismiss-link{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_mobile_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-woo_store_notice_dismiss_link-mobile-letter-spacing");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_store_notice_dismiss_link-mobile-letter-spacing">@media (max-width: 480px){.demo_store .woocommerce-store-notice__dismiss-link{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_store_notice_dismiss_link_typography[text-transform]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            var $child = $(".customizer-typography-store-dismiss-notice-text-transform");
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-store-dismiss-notice-text-transform">.demo_store .woocommerce-store-notice__dismiss-link{text-transform: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
